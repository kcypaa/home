...
(function($) {
    ...
    $('#btn_1').click(function() {
        ...
        var coordinates = GetScreenCordinates($('#projects')[0]);
        console.log(coordinates)

        // $("body","html").scrollLeft(coordinates.x);
        if ($(window).width() > 720) {
            $("body", "html").animate({ scrollLeft: coordinates.x }, 500, 'swing');
        } else {
            $("body", "html").animate({ scrollTop: coordinates.y }, 500, 'swing');
        }
